    ...
    <>
        <section className="bg-white dark:bg-gray-950">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical issue? Want to send feedback about a post? Need details about me? Let me know.</p>
                <form action="/contact" onSubmit={handleSubmit} className="space-y-8">
                    <div>
