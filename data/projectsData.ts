const projectsData = [
  {
    ...
    description: `Ryan Holiday explores the detrimental impact of ego on success. 
    The book highlights how unchecked ego can hinder personal and professional growth. 
    It emphasizes the importance of humility, perseverance, and continuous learning. 
  ...
  },
  {
    ...
    description: `"La Vie liquide" est un livre du sociologue Zygmunt Bauman qui examine la nature évolutive et instable de la société contemporaine. 
    L'auteur soutient que la modernité a créé une société "liquide" caractérisée par des relations et des identités flexibles et précaires. 
